...
<div class="row">
    <div class="col-md-4 text-center">
        <img src="<?= APP_URL ?>/uploads/avatars/<?= $user->avatar ?: 'default.png' ?>" class="rounded-circle img-thumbnail" width="150">
        <form method="POST" action="<?= APP_URL ?>/profile/avatar" enctype="multipart/form-data" class="mt-3">
        ...
        <div class="row">
            <?php foreach ($prizes as $prize): ?>
                <div class="col-2 text-center">
                    <img src="<?= APP_URL ?>/images/prizes/<?= $prize['image'] ?: 'default.png' ?>" width="50">
